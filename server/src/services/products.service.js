  ...
  try {
    ...
    const product = await prisma.product.create({
      data: {
        ...
        price:       data.price,
        priceMin:    data.priceMin != null ? parseFloat(data.priceMin) : null,
        priceMax:    data.priceMax != null ? parseFloat(data.priceMax) : null,
  ...
  try {
    ...
    const updated = await prisma.product.update({
      ...
      data: {
        ...
        ...(data.priceMin    !== undefined && { priceMin:    data.priceMin != null ? parseFloat(data.priceMin) : null }),
        ...(data.priceMax    !== undefined && { priceMax:    data.priceMax != null ? parseFloat(data.priceMax) : null }),
